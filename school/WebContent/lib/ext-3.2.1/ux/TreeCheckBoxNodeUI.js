...
Ext.ux.TreeCheckBoxNodeUI = function() {
	//多选: 'multiple'(默认)
	//单选: 'single'
	...
	Ext.ux.TreeCheckBoxNodeUI.superclass.constructor.apply(this, arguments);
};

Ext.extend(Ext.ux.TreeCheckBoxNodeUI, Ext.tree.TreeNodeUI, {
